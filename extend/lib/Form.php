...
class Form
{
    ...
    public static function image($name, $val = '', $style = 'width:370px', $iscropper = false) {
        $string='
            ...
            <div class="layui-input-inline" style="width: 120px">
                <button type="button" class="layui-btn" id="test3" onclick="hui_upload_att(\''.url('upload/upload_box', array('module'=>Request::module(), 'pid'=>$name)).'\')" ><i class="layui-icon">&#xe67c;</i>浏览文件</button>
            </div>
        ';
    ...
    public static function attachment($name, $val = '', $style='width:370px') {
        ...
        <div class="layui-input-inline" style="width: 45%">
            ...
            <div class="layui-input-inline" style="width: 120px">
                <button type="button" class="layui-btn" id="test3" onclick="hui_upload_att(\''.url('upload/upload_box', array('module'=>Request::module(), 'pid'=>$name,'t'=>2)).'\')" ><i class="layui-icon">&#xe67c;</i>浏览文件</button>
            </div>
        </div>
        ';
        return $string;
