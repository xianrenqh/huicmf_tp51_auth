...
CREATE TABLE `hui_article`  (
  ...
  `option_test` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '选项1',
  `bianjiqi` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `bianjiqi_mini` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `inputinput` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `arcio` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '女',
  `checkbox_test` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `timesss` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
...
INSERT INTO `hui_auth_group` VALUES (2, 1, '总编', '56,57,58,59,60,61,62,63,64,65,66,67,68,69,70,73,74,75,76,71,72,25,26,39,40,41,42,43,44,45,46,54,55,28,35,36,37,38,1,21,22,27,33,29,30,34,49,51,52,53', 1585633358, 0, 'normal');
INSERT INTO `hui_auth_group` VALUES (3, 2, '发布人员', '56,57,58,59,61,62,63,64,25,26,39,40,42,43,44,45,38,1,21,22,49,51,52', 1585633454, 0, 'normal');
...
) ENGINE = InnoDB AUTO_INCREMENT = 88 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '节点表' ROW_FORMAT = Compact;
...
INSERT INTO `hui_auth_rule` VALUES (78, 'file', 77, 'banner/cat_add', '添加幻灯分类', 'icon-round_text_fill', '', '', 0, 1585633735, 0, 1, 'normal');
INSERT INTO `hui_auth_rule` VALUES (79, 'file', 1, 'general.attachment/index', '附件管理', 'icon-picfill', '', '', 1, 1585634129, 0, 11, 'normal');
INSERT INTO `hui_auth_rule` VALUES (80, 'file', 79, 'general.attachment/delete', '删除附件', 'icon-round_text_fill', '', '', 0, 1585634150, 0, 1, 'normal');
INSERT INTO `hui_auth_rule` VALUES (81, 'file', 56, 'content/index', '内容管理', 'icon-edit', '', '', 1, 1585634694, 1585635304, 1, 'normal');
INSERT INTO `hui_auth_rule` VALUES (82, 'file', 25, 'datareplace/index', '数据库内容替换', 'icon-choicenessfill', '', '', 1, 1585637663, 0, 96, 'normal');
INSERT INTO `hui_auth_rule` VALUES (83, 'file', 82, 'datareplace/dosql', '执行sql替换', 'icon-round_text_fill', '', '', 0, 1585637790, 0, 1, 'normal');
...
-- ----------------------------
INSERT INTO `hui_model` VALUES (1, '文章模型', 'article', '文章模型', '', 1586401933, 0, 0, 0, 0, 1);
INSERT INTO `hui_model` VALUES (2, '产品模型', 'product', '产品模型', '', 1586401930, 0, 0, 0, 0, 1);
INSERT INTO `hui_model` VALUES (3, '下载模型', 'download', '下载模型', '', 1586414921, 0, 1, 0, 0, 1);
...
INSERT INTO `hui_model_field` VALUES (37, 3, 'stars', '评分等级', '', '', 0, 20, '', 'radio', '启用', '{\\\"0\\\":\\\"\\\\u4e00\\\\u661f\\\",\\\"1\\\":\\\"\\\\u4e8c\\\\u661f\\\",\\\"2\\\":\\\"\\\\u4e09\\\\u661f\\\",\\\"3\\\":\\\"\\\\u56db\\\\u661f\\\",\\\"4\\\":\\\"\\\\u4e94\\\\u661f\\\"}', 0, 0, 0, 1, 1, 0, 0, 1);
INSERT INTO `hui_model_field` VALUES (38, 1, 'test', '测试字段', '测试字段1', '', 1, 100, '', 'textarea', '', '', 1, 0, 0, 0, 1, 0, 0, 1);
INSERT INTO `hui_model_field` VALUES (40, 1, 'images', '多图上传', '', '', 0, 100, '', 'images', '', NULL, 0, 0, 0, 1, 1, 0, 0, 1);
INSERT INTO `hui_model_field` VALUES (41, 1, 'option_test', '下拉测试', '', '', 0, 100, '', 'select', '选项3', '{\\\"0\\\":\\\"\\\\u9009\\\\u98791\\\",\\\"1\\\":\\\"\\\\u9009\\\\u98792\\\",\\\"2\\\":\\\"\\\\u9009\\\\u98793\\\"}', 0, 0, 0, 1, 1, 0, 0, 1);
INSERT INTO `hui_model_field` VALUES (42, 1, 'bianjiqi', '编辑器', '', '', 0, 100, '', 'editor', '', NULL, 0, 0, 0, 1, 1, 1, 0, 1);
INSERT INTO `hui_model_field` VALUES (43, 1, 'bianjiqi_mini', '编辑器迷你', '', '', 0, 100, '', 'editor_mini', '', NULL, 0, 0, 0, 1, 1, 1, 0, 1);
INSERT INTO `hui_model_field` VALUES (44, 1, 'inputinput', 'input', '这是提示哦', '', 1, 100, '不能为空哦', 'input', '', NULL, 1, 0, 0, 1, 1, 0, 0, 1);
INSERT INTO `hui_model_field` VALUES (45, 1, 'arcio', '单选框', '', '', 0, 100, '', 'radio', '女', '{\\\"0\\\":\\\"\\\\u7537\\\",\\\"1\\\":\\\"\\\\u5973\\\",\\\"2\\\":\\\"\\\\u4eba\\\\u5996\\\"}', 0, 0, 0, 1, 1, 0, 0, 1);
INSERT INTO `hui_model_field` VALUES (46, 1, 'checkbox_test', '多选测试', '', '', 0, 100, '', 'checkbox', '', '{\\\"0\\\":\\\"\\\\u6d4b\\\\u8bd51\\\",\\\"1\\\":\\\"\\\\u6d4b\\\\u8bd52\\\",\\\"2\\\":\\\"\\\\u6d4b\\\\u8bd53\\\",\\\"3\\\":\\\"\\\\u6d4b\\\\u8bd54\\\"}', 0, 0, 0, 1, 1, 0, 0, 1);
INSERT INTO `hui_model_field` VALUES (47, 1, 'timesss', '时间类型', '', '', 0, 100, '', 'datetime', '', '{\\\"0\\\":\\\"1\\\"}', 0, 0, 0, 1, 1, 0, 0, 1);
...
-- ----------------------------
-- Table structure for hui_product
-- ----------------------------
...
CREATE TABLE `hui_product`  (
  ...
  `pictures` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '产品图集',
