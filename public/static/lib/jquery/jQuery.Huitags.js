		...
		this.each(function(){
			...
			'<div class="Huitags-wraper">'+
				'<div class="Huitags-input-wraper">'+
					'<input type="text" class="layui-input Huitags-input" placeholder="添加标签，用空格分隔" maxlength="'+options.maxlength+'" value="">'+
				'</div>'+
				...
				'</div>'+
				'<input type="hidden" class="layui-input Huitags-val" name="" value="'+options.value+'">'+
			'</div>';
			that.append(str);
